...
public class SectorJpaController implements Serializable {
    ...
    public void upLoad() {
        Sector s1 = new Sector("Pendiente");
        Sector s2 = new Sector("En Proceso");
        Sector s3 = new Sector("Completo");
        Sector s4 = new Sector("Esperando Despacho");
        Sector s5 = new Sector("Despacho");
        Sector s6 = new Sector("Esperando Entrega");
        Sector s7 = new Sector("Entrega");
